			...
			<div class="bg-white shadow rounded-lg overflow-hidden">
				...
				>
					...
					<div class="flex justify-end space-x-3">
						...
						>
							<span v-if="!projectsStore.isLoading">Создать проект</span>
							<svg
								v-else
...
import type { CreateProjectBody } from '../../api/index.ts';
import { useProjectsStore, useTeamsStore } from '../../stores/index.ts';
