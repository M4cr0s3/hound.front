    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
          ...
          <div v-if="team.projects.length"
               class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
              <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold text-gray-900">Проекты команды</h2>
                <span
          ...
          <div v-if="team.assignments.length"
               class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
              <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold text-gray-900">Активные задачи</h2>
                <span
                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">
                  {{ team.assignments.length }} задач
                </span>
              </div>
            </div>
            <ul class="divide-y divide-gray-100">
              <li
                  v-for="assignment in team.assignments"
                  :key="assignment.id"
        ...
        <div class="space-y-6">
          <div v-if="team.members.length" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
              <div class="flex items-center justify-between">
            ...
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50">
              <RouterLink
                  :to="ROUTES.TEAM.EDIT.replace(':slug', team.slug)"
      ...
      <EmptyState
          v-if="!team.projects.length && !team.assignments.length"
          title="Команда пуста"
